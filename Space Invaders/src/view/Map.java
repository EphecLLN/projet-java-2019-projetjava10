...
public class Map {
	...
	public final static int SHIP_HEIGHT=33;
	public final static int SHIP_WIDTH=80;
	public final static int SHIP_START_X=450;
	public final static int SHIP_START_Y=700;
	...
	public final static int DEFENSES_A_X=450;
	public final static int DEFENSES_A_Y=500;
